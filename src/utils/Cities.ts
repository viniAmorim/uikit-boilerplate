...
export const getCitiesByDistrict = (stateValue: string) => {
  const selectedCity = stateValue
    ? cities.filter((city) => city.sigla === stateValue)[0]
    : null;
  const selectedCities = selectedCity
    ? selectedCity.cidades.map((cidade) => {
